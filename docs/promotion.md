...
The latest public handoff is recorded in [Discussion #82](https://github.com/sandbaseai/sandbase-harness/discussions/82#discussioncomment-18206531).
...
- [Plugin Hub duplicate-install issue #78](https://github.com/sandbaseai/sandbase-harness/issues/78): open; added a non-destructive recovery path (update Hub, remove only the exact residual target, retry the fixed HTTPS Git source) and opened the upstream [Plugin Hub issue #25](https://github.com/dshplugin/dsh-plugin-hub/issues/25) for the idempotency fix ([project comment](https://github.com/sandbaseai/sandbase-harness/issues/78#issuecomment-5468727246)).
