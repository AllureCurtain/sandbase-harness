...
- [Best of Agent Harnesses PR #99](https://github.com/RyanAlberts/best-of-Agent-Harnesses/pull/99) — submitted the v0.3.8 Harness entry to the generated ranked catalog; the PR now follows the destination's generator-source contract, regenerated outputs, and passes 54 tests locally; maintainer review pending ([update](https://github.com/RyanAlberts/best-of-Agent-Harnesses/pull/99#issuecomment-5475686927))
