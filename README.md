...
- [TensorBlock Awesome MCP Servers issue #2067](https://github.com/TensorBlock/awesome-mcp-servers/issues/2067) — automated PR #2068 needs its generated install metadata corrected to include the GHCR image and environment flags; maintainer regeneration pending ([correction](https://github.com/TensorBlock/awesome-mcp-servers/issues/2067#issuecomment-5473393345))
- [Awesome Agent-Native Services PR #116](https://github.com/haoruilee/awesome-agent-native-services/pull/116) — curator-approved dossier with v0.3.8 runtime, MCP, session, approval, credential, and audit/replay evidence; PR is mergeable but blocked by the repository gate, awaiting curator merge ([verification](https://github.com/haoruilee/awesome-agent-native-services/pull/116#issuecomment-5473455471))
...
- [BotMarket MCP submission #4](https://botmarket.bot/submit) — canonical `server.json` metadata parsed and queued for manual review; no public listing claimed
