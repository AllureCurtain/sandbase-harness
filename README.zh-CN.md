...
- [Awesome AI Agent Tools PR #27](https://github.com/michielhdoteth/awesome-ai-agent-tools/pull/27) — 已新增独立的 SandBase Harness MCP 目录条目和 Docker stdio 安装元数据，PR 可合并，等待维护者审核
