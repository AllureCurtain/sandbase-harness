...
- [Picrew Awesome Agent Harness issue #82](https://github.com/Picrew/awesome-agent-harness/issues/82) — 提议将 DeepSeek Harness Handbook 纳入 Documentation / Learning，等待目录审核
