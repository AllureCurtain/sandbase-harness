...
parameter** (24 h) rather than a conformed value; see §4. What remains absent is
reset-on-success and the published 5–120 s jittered backoff (locally a fixed 60 s/120 s).
